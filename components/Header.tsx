            ...
            >
              ...
              {hoveredItem === item.path && (
                <div className="absolute -bottom-20 left-1/2 -translate-x-1/2 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="whitespace-nowrap rounded-md border-2 border-zinc-400 bg-zinc-900 px-3 py-1.5 text-sm font-medium text-white shadow-lg dark:border-zinc-600 dark:bg-black">
                    {item.label}
                  </div>
                </div>
              )}
